...
const navItems = [
  ...
  { key: 'tickets', href: '/tickets', icon: 'icon2.svg' },
  { key: 'chat', href: '/chat', icon: 'icon3.svg' },
  { key: 'user', href: '/user', icon: 'icon4.svg' },
  { key: 'simulator', href: '/simulator', icon: 'icon5.svg' },
]
...
export function Sidebar() {
  ...
  return (
    <div className="h-screen py-6 sticky top-0 z-40">
      <div className="absolute top-0 bg-[#20273e] h-screen flex-col items-center py-6 w-32.5 rounded-r-[40px] shadow-[4px_0px_20px_0px_rgba(0,0,0,0.5)] flex z-60">
        <div className="mb-8">
          <Link href="/dashboard">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Tooltip key={item.href} delayDuration={0}>
                  <TooltipTrigger asChild>
                    <Link
                      ...
                      className={cn(
                        ...
                        isActive
                          ? 'bg-loomi-primary shadow-[0px_0px_20px_0px_rgba(24,118,210,0.5)]'
                          : 'bg-[#2b3248]',
                      )}
                    >
                  ...
                  <TooltipContent
                    color="#1876D2"
                    className="bg-loomi-primary text-white border-0"
                    side="right"
                  >
                    {t(item.key)}
                  </TooltipContent>
      ...
      <div className="absolute top-0 h-1/2 w-32.5 bg-[#20273e] z-50 "></div>
    </div>
  )
}
