    ...
    return (
        <div className="space-y-[40px] h-full flex flex-col">
            <Container className="bg-[#171d30] space-y-[32px]">
                <h2 className="text-xl font-semibold">Benefícios Inclusos</h2>
            ...
            <Container className="flex-1 flex flex-col">
                <h2 className="text-xl font-semibold mb-[32px]">Indicadores</h2>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex gap-3 text-sm">
                                        <span className="text-white/60">
                                            Conversão: <span className="text-green-400 drop-shadow-[0_0_8px_rgba(3,200,9,0.8)]">{plan.conversion}%</span>
                                        </span>
                                        <span className="text-white/60">
                                            ROI: <span className="text-green-400 drop-shadow-[0_0_8px_rgba(3,200,9,0.8)]">{plan.roi}%</span>
                                        </span>
                                    </div>
                                </div>
