...
export const planCalculatePrice = ({ planValue, vehicleValue, clientAge, selectedAddons }: { planValue: number, vehicleValue: number, clientAge: number, selectedAddons: string[] }) => {
