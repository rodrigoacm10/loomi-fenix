...
export const useTicketStore = create<TicketState>((set) => ({
  ...
  openTicketModal: (ticket, viewMode = false) =>
    set({
  ...
  closeTicketModal: () =>
    set({ isTicketModalOpen: false, selectedTicket: null, isViewMode: false }),

  openDeleteModal: (ticket) =>
    set({ isDeleteModalOpen: true, ticketToDelete: ticket }),
  closeDeleteModal: () =>
    set({ isDeleteModalOpen: false, ticketToDelete: null }),
}))
